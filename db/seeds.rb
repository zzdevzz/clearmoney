...
articles = [
  ...
  { title: "Importance of investing early?", description: "Understand the importance of investing early and the power of compounding interest. This allows you to build a larger balance over time — even without extra capital investment.", url: "https://www.bankrate.com/investing/millennial-guide-to-investing/" },
